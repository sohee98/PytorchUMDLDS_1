...
HEIGHT = 256
SUB_FOLDER = 'train'
# INPUT_DIR = '/seokju4/Dataset/Cityscapes/cityscapes'
INPUT_DIR = '../cityscapes'
# OUTPUT_DIR = '/seokju4/Dataset/fei-Dataset/cityscapes-Wild-256/train'
OUTPUT_DIR = '../cityscapes-Wild-256/train2'
...
for f in glob.glob(OUTPUT_DIR + '/*/*.png'):
    ...
    if int(img_name) >1 and int(img_name) < 15:
