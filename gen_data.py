...
# import pdb
# python gen_data.py --dataset_name kitti_raw_stereo --dataset_dir ./datasets/data_prep/kitti_raw --save_dir ./gen_data --mask color --single_process
# python gen_data.py --dataset_name kitti_raw_eigen --dataset_dir ./datasets/data_prep/kitti_raw --save_dir ./gen_data --mask color --single_process
